 ...
 */
public class nyTimesMovie implements Serializable {
    ...
    public nyTimesMovie(String headline, String description, String summary_short, String link, String picUrl, String editor, String date) {
