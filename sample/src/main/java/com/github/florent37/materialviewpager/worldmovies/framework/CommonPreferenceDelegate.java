...
import com.github.florent37.materialviewpager.worldmovies.util.PreferenceUtils;
...
class CommonPreferenceDelegate implements Lockable {
    ...
    public void onBindView(View view) {
        ...
        textView.setBackgroundColor(PreferenceUtils.getAttrColor(mPreference.getContext(), R.attr.colorAccent));
