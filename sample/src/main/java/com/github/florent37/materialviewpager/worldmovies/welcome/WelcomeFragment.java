 ...
 */
package com.github.florent37.materialviewpager.worldmovies.welcome;
...
public abstract class WelcomeFragment extends Fragment {
    ...
    /**
     * Get the {@link View.OnClickListener} for the positive action click event.
     *
    ...
    /**
     * Get the {@link View.OnClickListener} for the negative action click event.
     *
     * @return the click listener.
     */
    ...
    /**
     * A convience {@link View.OnClickListener} for the common use case in the
