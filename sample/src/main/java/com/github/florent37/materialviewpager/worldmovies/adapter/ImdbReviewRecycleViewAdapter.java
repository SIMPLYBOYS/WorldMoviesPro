 ...
 */
public class ImdbReviewRecycleViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ImdbReviewRecycleViewAdapter(Context context, ArrayList<ReviewItem> items) {
