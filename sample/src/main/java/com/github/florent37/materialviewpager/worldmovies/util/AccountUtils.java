 ...
 * associated with the account, also support Facebook account.
 */
public class AccountUtils {
    ...
    public static boolean clearActiveAccount(final Context context){
        Log.d("0315", "remove active account");
        SharedPreferences sp = getSharedPreferences(context);
