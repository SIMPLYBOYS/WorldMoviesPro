...
package com.github.florent37.materialviewpager.worldmovies.provider;
...
import com.github.florent37.materialviewpager.worldmovies.provider.ScheduleContract.Announcements;
import com.github.florent37.materialviewpager.worldmovies.provider.ScheduleContract.Blocks;
import com.github.florent37.materialviewpager.worldmovies.provider.ScheduleContract.Feedback;
import com.github.florent37.materialviewpager.worldmovies.provider.ScheduleContract.HashtagColumns;
import com.github.florent37.materialviewpager.worldmovies.provider.ScheduleContract.Hashtags;
import com.github.florent37.materialviewpager.worldmovies.provider.ScheduleContract.MapMarkers;
import com.github.florent37.materialviewpager.worldmovies.provider.ScheduleContract.MapTiles;
import com.github.florent37.materialviewpager.worldmovies.provider.ScheduleContract.MyFeedbackSubmitted;
import com.github.florent37.materialviewpager.worldmovies.provider.ScheduleContract.MySchedule;
import com.github.florent37.materialviewpager.worldmovies.provider.ScheduleContract.MyScheduleColumns;
import com.github.florent37.materialviewpager.worldmovies.provider.ScheduleContract.MyViewedVideos;
import com.github.florent37.materialviewpager.worldmovies.provider.ScheduleContract.Rooms;
import com.github.florent37.materialviewpager.worldmovies.provider.ScheduleContract.SearchSuggest;
import com.github.florent37.materialviewpager.worldmovies.provider.ScheduleContract.SearchTopicsSessions;
import com.github.florent37.materialviewpager.worldmovies.provider.ScheduleContract.Sessions;
import com.github.florent37.materialviewpager.worldmovies.provider.ScheduleContract.Speakers;
import com.github.florent37.materialviewpager.worldmovies.provider.ScheduleContract.Tags;
import com.github.florent37.materialviewpager.worldmovies.provider.ScheduleContract.VideoColumns;
import com.github.florent37.materialviewpager.worldmovies.provider.ScheduleContract.Videos;
import com.github.florent37.materialviewpager.worldmovies.provider.ScheduleDatabase.SessionsSearchColumns;
import com.github.florent37.materialviewpager.worldmovies.provider.ScheduleDatabase.SessionsSpeakers;
import com.github.florent37.materialviewpager.worldmovies.provider.ScheduleDatabase.Tables;
...
import com.github.florent37.materialviewpager.worldmovies.util.SelectionBuilder;
...
import static com.github.florent37.materialviewpager.worldmovies.util.LogUtils.LOGV;
...
public class ScheduleProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        Log.d("0225", "ViewPager Provider onCreate");
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        Log.v("0222", "uri=" + uri + " code=" + matchingUriEnum.code + " proj=" +
                Arrays.toString(projection) + " selection=" + selection + " args="
                + Arrays.toString(selectionArgs) + ")");

        switch (matchingUriEnum) {
            default: {
                Log.d("0222", "default query");
    ...
    public Uri insert(Uri uri, ContentValues values) {
        LOGV("0222", "insert(uri=" + uri + ", values=" + values.toString()
                + ", account=" + getCurrentAccountName(uri, false) + ")");
        LOGV(TAG, "insert(uri=" + uri + ", values=" + values.toString()
                + ", account=" + getCurrentAccountName(uri, false) + ")");Log.d("0225", "Provider onCreate");
        ...
        switch (matchingUriEnum) {
            ...
            case SESSIONS_MY_SCHEDULE: {
                ...
                return builder.table(Tables.MY_SCHEDULE)
                        .where(MyScheduleColumns.SESSION_ID + "=?", sessionId);
            }
            case MY_SCHEDULE: {
                return builder.table(Tables.MY_SCHEDULE)
