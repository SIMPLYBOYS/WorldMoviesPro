...
public class pttMovie implements Serializable {
    ...
    public pttMovie(String headline, String description, String summary_short, String link, String picUrl, String editor, String date) {
